...
(function () {
  ...
  var T = {
    cs: {
      ...
      lPool: 'Bazén', vPool: 'Zastřešený; vyhřívaný na ~27 °C v letní sezóně. V zimě mimo provoz.',
    ...
    en: {
      ...
      lPool: 'Pool', vPool: 'Indoor; heated to ~27 °C in the summer season. Closed in winter.',
    ...
    de: {
      ...
      lPool: 'Pool', vPool: 'Überdacht; in der Sommersaison auf ~27 °C beheizt. Im Winter außer Betrieb.',
    ...
    pl: {
      ...
      lPool: 'Basen', vPool: 'Zadaszony; w sezonie letnim ogrzewany do ~27 °C. Zimą nieczynny.',
