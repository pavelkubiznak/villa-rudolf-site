...
(function () {
  ...
  var T = {
    cs: {
      nav: { dum: 'Dům', vybaveni: 'Vybavení', galerie: 'Galerie', loznice: 'Interiér', lokalita: 'Lokalita', vylety: 'Výlety', info: 'Praktické info', cta: 'Rezervovat termín' },
      ...
      w: {
        lyzovani: { name: 'Lyžování Černá hora–Pec', meta: 'Sjezdovky 4 km · zastávka skibusu od brány', pitch: 'SkiResort Černá hora–Pec máte prakticky za rohem — jeden skipas platí v několika areálech. Skibus staví 200 metrů od brány, takže se k vlekům dostanete bez auta a bez hledání parkování; podmínky přepravy si ověřte u provozovatele.' },
    ...
    en: {
      nav: { dum: 'The House', vybaveni: 'Amenities', galerie: 'Gallery', loznice: 'Interior', lokalita: 'Location', vylety: 'Trips', info: 'Guest info', cta: 'Book dates' },
      ...
      w: {
        lyzovani: { name: 'Skiing at Černá hora–Pec', meta: 'Slopes 4 km · ski-bus stop by the gate', pitch: 'SkiResort Černá hora–Pec is practically around the corner — one ski pass covers several areas. The ski bus stops 200 metres from the gate, so you reach the lifts without a car or a parking hunt; check current fares with the operator.' },
    ...
    de: {
      nav: { dum: 'Das Haus', vybaveni: 'Ausstattung', galerie: 'Galerie', loznice: 'Innenräume', lokalita: 'Lage', vylety: 'Ausflüge', info: 'Gäste-Infos', cta: 'Termin buchen' },
      ...
      w: {
        lyzovani: { name: 'Skifahren Černá hora–Pec', meta: 'Pisten 4 km · Skibus-Haltestelle am Tor', pitch: 'SkiResort Černá hora–Pec liegt praktisch um die Ecke — ein Skipass gilt in mehreren Skigebieten. Der Skibus hält 200 Meter vom Tor, so kommt ihr ohne Auto und ohne Parkplatzsuche zu den Liften; die Beförderungsbedingungen bitte beim Betreiber prüfen.' },
    ...
    pl: {
      nav: { dum: 'Dom', vybaveni: 'Udogodnienia', galerie: 'Galeria', loznice: 'Wnętrza', lokalita: 'Lokalizacja', vylety: 'Wycieczki', info: 'Informacje praktyczne', cta: 'Zarezerwuj termin' },
      ...
      w: {
        lyzovani: { name: 'Narciarstwo Czarna Góra–Pec', meta: 'Stoki 4 km · przystanek skibusu od bramy', pitch: 'SkiResort Černá hora–Pec masz praktycznie za rogiem — jeden skipas obowiązuje w kilku ośrodkach. Skibus zatrzymuje się 200 metrów od bramy, więc dojedziesz do wyciągów bez auta i szukania parkingu; warunki przewozu sprawdźcie u przewoźnika.' },
