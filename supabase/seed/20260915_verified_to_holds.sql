...
--
-- ✅ SPUŠTĚNO V ŽIVÉ DB 23. 9. 2026 (konektor Supabase). Přibyly dva řádky:
--    2027-08-07..14 confirmed a 2027-02-13..20 expired. Termín 2027-08-14..21 se
--    přeskočil — majitel ho mezitím (17. 9.) založil sám v /sprava/. Údaje o platbě
--    k němu se doplnily přímo v DB (do veřejného repa nepatří).
--    Znovu to pouštět netřeba, ale nic by to nerozbilo.
--
-- PROČ
